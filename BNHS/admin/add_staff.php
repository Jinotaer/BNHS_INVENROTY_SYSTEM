            ...
            <div class="card-body">
              <form method="POST">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="staff_id" class="form-control"> <!-- Added visible input for Staff ID -->
                  </div>
                  <div class="col-md-6">
                    <label>Staff Name</label>
                    <input type="text" name="staff_name" class="form-control"> <!-- Corrected 'stafS_name' to 'staff_name' -->
                  </div>
                </div>
                <hr>
