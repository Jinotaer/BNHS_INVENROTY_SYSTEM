                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input style="color: black;" type="text" name="staff_name" value="<?php echo $staff->staff_name; ?>"
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input style="color: black;" type="email" id="input-email" value="<?php echo $staff->staff_email; ?>"
                            name="staff_email" class="form-control form-control-alternative">
                        </div>
                      </div>
